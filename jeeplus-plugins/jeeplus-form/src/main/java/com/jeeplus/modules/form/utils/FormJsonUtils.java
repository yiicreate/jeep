...
public class FormJsonUtils {
    ...
    void generateModel(JSONArray genList) {
        for (int i = 0; i < genList.size(); i++) {
            ...
            if ("grid".equals(orderedMap.get("type"))) {
                ...
                if ((orderedMap.getJSONObject("options")).getBoolean("dataBind")) {
                        Column gzColumn = new Column();
    ...
    void generateModelForApp(JSONArray genList) {
        for (int i = 0; i < genList.size(); i++) {
            ...
            if ("grid".equals(orderedMap.get("type"))) {
                ...
                if ( orderedMap.getJSONObject("options").containsKey("dataBind")
                        && (orderedMap.getJSONObject("options")).getBoolean("dataBind")) {
    ...
    public List<Column>  getFields(String json){
    ...
    public List<Column>  getFieldsByTable(String json, String model){
        JSONArray list = JSONObject.fromObject(json).getJSONArray("list");
    ...
    public static void main(String[]args){
        System.out.println(JSON.toJSONString(FormJsonUtils.newInstance().getFieldsByTable(json1, "childTable->test_data_child3" )));
        System.out.println (JSON.toJSONString (FormJsonUtils.newInstance().getFieldsForApp (json1)));
    }
}
